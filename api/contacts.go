...
func ContactList(c web.C, w http.ResponseWriter, r *http.Request) {
...
func ContactItem(c web.C, w http.ResponseWriter, r *http.Request) {
	var db = database.FromContext(c)
...
func ContactAdd(c web.C, w http.ResponseWriter, r *http.Request) {
	var db = database.FromContext(c)
...
func ContactUpdate(c web.C, w http.ResponseWriter, r *http.Request) {
	var db = database.FromContext(c)
...
func ContactDelete(c web.C, w http.ResponseWriter, r *http.Request) {
	var db = database.FromContext(c)
...
func ContactGroups(c web.C, w http.ResponseWriter, r *http.Request) {
	var db = database.FromContext(c)
	...
	res := utils.Response{Result: "success", Data: ct}
	utils.EncodePayload(w, http.StatusOK, res)
}
